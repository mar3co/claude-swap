...
struct CSwapWidgetIntent: WidgetConfigurationIntent {
    static var title: LocalizedStringResource = "cswap"
    ...
    static var parameterSummary: some ParameterSummary {
        When(\CSwapWidgetIntent.$layout, .equalTo, WidgetLayout.one) {
