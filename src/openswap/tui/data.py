...
``openswap.snapshot_source.SnapshotSource`` (shared with any GUI shell);
...
from openswap import oauth, printer, usage_store
from openswap.exceptions import ClaudeSwitchError
from openswap.snapshot_source import SnapshotSource
from openswap.switcher import SENTINEL_NOTES, last_seen_note
...
def sentinel_label(sentinel: str) -> str:
    """The same wording ``openswap list`` prints for this sentinel state."""
