"""The openswap Textual application.
...
from openswap.snapshot_source import account_identity
from openswap.settings import load_settings, load_ui_settings, set_setting
...
from openswap.tui.data import ActionResult, SnapshotSource, format_duration, run_action
from openswap.tui.modals import AddTokenModal, ConfirmModal, OutputModal, TokenForm
from openswap.tui.theme import CSWAP_DARK, CSWAP_LIGHT


class CswapApp(App):
    """openswap interactive dashboard."""

    TITLE = "OpenSwap"
    CSS_PATH = "openswap.tcss"
    ...
    def __init__(
        ...
        *,
        ...
        self._start = start  # "dashboard" | "watch" (`openswap watch`)
    ...
    def on_mount(self) -> None:
        ...
        self.theme = f"openswap-{resolved}"
