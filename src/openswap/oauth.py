...
from openswap.printer import warning as print_warning
...
def _persist(
    ...
    try:
        ...
        _logger.warning(
            ...
            "with invalid_grant, re-run `openswap --add-account` after logging in.",
            account_num,
            email,
            e,
        )
        print_warning(
            ...
            f"If the next refresh fails, re-run `openswap --add-account` after logging in."
        )
